...
create database Krishna_suresh_Ecommerce_User_recomendation_and_user_Behaviour_Analytics;

----- use database
use Krishna_suresh_Ecommerce_User_recomendation_and_user_Behaviour_Analytics;
